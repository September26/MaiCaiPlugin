...
public class IOHelper {
    ...
    public static void write2File(Context context, List<String> list) {
        File record = context.getExternalFilesDir("record");
        long l = System.currentTimeMillis();
        File file = new File(record.getAbsolutePath() + File.separator + "record_" + l + ".txt");
        String s = IOHelper.listToStr(list);
        LogUtil.logI("writeTo:" + file.getAbsolutePath());
        IOHelper.writerStrByCodeToFile(file, "utf-8", true, s);
    }
